...
import {setOutlierRemovalColumns} from "../../../../reducers/nodeSlice";
...
export default function OutlierRemoval(props){

    const dispatch = useDispatch();
    const dataFeaturing = useSelector((state)=>state.outlier_removal_columns);
    ...
    const handleDone = ()=>{
        ...
        dispatch(setOutlierRemovalColumns(checked));
        props.handleClose();
    }
    ...
    <div>
        <ThemeProvider theme={darkTheme}>
          <Dialog open={props.open} onClose={props.handleClose} sx={{textAlign:"center", backgroundColor:""}} maxWidth="300" fullWidth="true" >
               <DialogTitle> Select columns to apply Outlier Removal </DialogTitle>
