...
import {setLogTransformationColumns} from "../../../../reducers/nodeSlice";
...
export default function LogTransformation(props){
    ...
    const dataFeaturing = useSelector((state)=>state.log_transformation_columns);
    ...
    const handleDone = ()=>{
        ...
        dispatch(setLogTransformationColumns(checked));
        props.handleClose();
    }
    ...
    <div>
        <ThemeProvider theme={darkTheme}>
          <Dialog open={props.open} onClose={props.handleClose} sx={{textAlign:"center", backgroundColor:""}} maxWidth="300" fullWidth="true" >
               <DialogTitle> Select columns to apply Log Transformation </DialogTitle>
